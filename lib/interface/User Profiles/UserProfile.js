      ...
      if (typeof window.getFirebaseProfile === 'function') {
        try {
          ...
          if (profile) {
            ...
            // Update display name if different from username
            ...
            // Use banner color from profile, fallback to permission-based color
            ...
            // Update avatar if custom profile picture exists
